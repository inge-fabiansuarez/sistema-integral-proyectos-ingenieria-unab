          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                    <h2 class="font-weight-bolder text-info text-gradient">{{ env('APP_NAME') }}</h2>
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    ...
                    <label>Usuario</label>
                    <div class="mb-3">
                      <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="fsuarez120@unab.edu.co" aria-label="Email" aria-describedby="email-addon">
                      @error('email')
                ...
                {{-- <small class="text-muted">Olvidó contraseña? Reset contraseña
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background:url('../assets/img/curved-images/imgen_login.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
