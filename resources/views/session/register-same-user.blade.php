            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">Crea tu cuenta.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form role="form text-left" method="POST" action="/register">
                                ...
                                <div class="mb-3">
                                    <input type="email" class="form-control" placeholder="Correo electrónico" name="email"
                                        id="email" aria-label="Correo electrónico" aria-describedby="email-addon"
                                        value="{{ old('email') }}">
                                    @error('email')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="form-check form-check-info text-left">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Acepto los <a href="javascript:;" class="text-dark font-weight-bolder">Términos y
                                            Condiciones</a>
                                    </label>
                                    @error('agreement')
                                        <p class="text-danger text-xs mt-2">Primero, acepta los Términos y Condiciones, luego intenta registrarte nuevamente.</p>
                                    @enderror
                                </div>
